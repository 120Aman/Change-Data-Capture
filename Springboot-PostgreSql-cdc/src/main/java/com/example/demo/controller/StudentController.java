...
import com.example.demo.service.StudentConnector;
...
public class StudentController {
	...
	@Autowired
	StudentConnector studentConnector;
	...
	public Student createStudent(@Validated @RequestBody Student student) throws IOException {
			studentConnector.studentconnector();
